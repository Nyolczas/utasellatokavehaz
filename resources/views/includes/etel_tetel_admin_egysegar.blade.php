<div class="card mb-2 tetel-card">
    <form method="POST" action="{{ $update }}">
        ...
        <div class="card-body">
            ...
            <textarea rows="{{ $areaRows }}" name="description"
                class="input-hide desc"> {{ $tetel->description }}</textarea>
        ...
        <div class="d-flex mt-1 card-footer justify-content-between">
            <input type="number" name="rank" value="{{ $tetel->rank }}" class="mr-1 px-1 input-hide input-rank"
                data-toggle="tooltip" data-placement="top" title="sorrend">
